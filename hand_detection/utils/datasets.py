...
from hand_detection.utils.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, resample_segments, \
    clean_str
from hand_detection.utils.torch_utils import torch_distributed_zero_first
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, stride=32):
        ...
        for i, s in enumerate(sources):
            ...
            if sources == '0':  # 针对摄像头强制使用720p的流(要看具体摄像头支持的大小)
